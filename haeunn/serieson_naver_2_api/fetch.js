...
//   if (e.key === "Enter") {
//     const movieNm = searchInput.value;
//     _fetch(
//       `http://www.kobis.or.kr/kobisopenapi/webservice/rest/movie/searchMovieList.json?key=f5eef3421c602c6cb7ea224104795888&movieNm=${movieNm}`
//     )
//       .then((res) => res.json())
//       .then((data) => {
...
//           .map((movie) => {
//             return `<li>
//                   <img class="movie-img" src="/images/지금 이대로가 좋아.png" />
//                   <p>
//                   <div class="sales-movie-name">
//                   ${movie.movieNm}
//                   </div>
//                   <div class="sales-movie-info">
//                   ${movie.typeNm}:(${movie.openDt})
//                   </div>
//                   </p>
//                 </li>`;
//           })
...
window.addEventListener("keydown", (e) => {
  if (e.key === "Enter") {
    const peopleNm = searchInput.value;
    _fetch(
      `http://kobis.or.kr/kobisopenapi/webservice/rest/people/searchPeopleList.json?key=f5eef3421c602c6cb7ea224104795888&peopleNm=${peopleNm}`
    )
      .then((res) => res.json())
      .then((data) => {
        const peopleList = data.peopleListResult.peopleList;
